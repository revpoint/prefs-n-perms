...
from prefs_n_perms import utils
...
class ConnectionFactory(object):
    ...
    def __init__(self, options):
        ...
        self.pool_cls = utils.load_class(pool_cls_path)
        ...
        self.redis_client_cls = utils.load_class(redis_client_cls_path)
